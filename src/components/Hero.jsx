      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 ">
        <div className=" grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="lg:py-24">
            ...
            <button className="mt-4 shadow-[0_4px_14px_0_rgb(0,118,255,39%)] hover:bg-[#62c0f7] hover:bg-[rgba(0,118,255,0.9)] px-8 py-2 bg-[#38B6FF] rounded-md text-white font-light transition duration-200 ease-linear">
              Get Started Today
            </button>
          </div>
        </div>
