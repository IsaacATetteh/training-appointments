      ...
      <div className="flex flex-col md:flex-row items-center = mx-auto px-4 py-8 border-0 border-black sm:px-6 sm:py-12 lg:px-14 lg:py-10 bg-indigo-100 text-gray-700 h-100 text-center">
        ...
        <div className="w-2/3 md:w-1/2 align-middle h-48 border-black">
          ...
          <ul className="mt-8  space-y-1 text-sm text-gray-700">
            ...
            <li>Saturaday: 2pm - 6pm</li>
            <li>Sunday: 9am - 6pm</li>
          </ul>
        </div>
        <div className="sm:w-2/3 md:w-1/2 h-48 border-black">
          ...
          <ul className="mt-3 md:mt-8 flex justify-center flex-rows gap-6 border-0 border-black h-7">
            <li>
              <a
                href="#"
                rel="noreferrer"
          ...
          <p className="mt-2">Email: richard@gmail.com</p>
        </div>
      </div>
    </section>
  );
